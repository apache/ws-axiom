...
package org.apache.axiom.jakarta.attachments.lifecycle.impl;
...
public class LifecycleManagerImpl implements LifecycleManager {
    ...
    /* (non-Javadoc)
     * @see org.apache.axiom.jakarta.lifecycle.LifecycleManager#create(java.lang.String)
     */
    @Override
    ...
    private VMShutdownHook registerVMShutdownHook() throws RuntimeException{
        ...
        try{
            hook = AccessController.doPrivileged((PrivilegedExceptionAction<VMShutdownHook>) () -> {
                VMShutdownHook vmShutdownHook = VMShutdownHook.hook();
                if(!vmShutdownHook.isRegistered()){
                    Runtime.getRuntime().addShutdownHook(vmShutdownHook);
                    vmShutdownHook.setRegistered(true);
                }
                return vmShutdownHook;
            });
