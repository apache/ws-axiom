...
package org.apache.axiom.jakarta.attachments.lifecycle;
...
public interface DataHandlerExt {
	 ...
	 * until the virtual machine exits as user can choose to read
	 * this dataHandler. So if user is not going to use the data 
	 * handlers provided on this temporary files they can choose
	 * to purge the file. 
	 */
