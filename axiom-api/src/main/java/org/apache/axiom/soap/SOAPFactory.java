...
public interface SOAPFactory extends OMFactory {
     ...
     * SOAP version that this factory represents. It will have the prefix given by {@link
     * SOAPConstants#SOAP_DEFAULT_NAMESPACE_PREFIX}. It will also have a corresponding namespace
     * declaration.
     *
     ...
     *
     * @param ns the namespace information for the SOAP envelope
     * @return the SOAP envelope
     */
    // TODO: specify what happens if there is a mismatch between the provided namespace URI and the
    // SOAP version of the factory
     ...
     *
     * <p>Note that for most use cases, it is preferable to use {@link
     * SOAPEnvelope#getOrCreateHeader()} instead of this method.
     *
     * @param envelope the parent of the {@link SOAPHeader}
     ...
     * namespace URI. The semantics of the method parameters are the same as for {@link
     ...
     * @throws SOAPProcessingException
     */
    SOAPHeaderBlock createSOAPHeaderBlock(String localName, OMNamespace ns, OMDataSource source)
            throws SOAPProcessingException;

    /**
     * Create a new {@link SOAPHeaderBlock} with the same content as the given element.
     *
     * @param element the element to import as a header block
     ...
     *
     * <p><b>Note:</b> This method is typically used in conjunction with {@link
     * SOAPEnvelope#getHeader()}. In order to avoid generating unnecessary empty SOAP headers, you
     * should consider using {@link #createDefaultSOAPMessage()} together with {@link
     * SOAPEnvelope#getOrCreateHeader()} instead. This method may be deprecated and/or removed in
     * future Axiom versions.
     *
     ...
     *
     * <p>Since no SOAP header is added to the envelope, this method should be used in conjunction
     * with {@link SOAPEnvelope#getOrCreateHeader()} (if SOAP header blocks need to be added).
     *
     * @return the default SOAP envelope
     */
    ...
    /**
     * Get the envelope namespace for the SOAP version used by this factory. The returned {@link
