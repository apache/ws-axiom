...
public class OMXMLBuilderFactory {
     ...
     *
     * <p>The reader must be positioned on a {@link XMLStreamConstants#START_DOCUMENT} or {@link
     * XMLStreamConstants#START_ELEMENT} event. If the current event is {@link
     * XMLStreamConstants#START_DOCUMENT} then the builder will consume events up to the {@link
     * XMLStreamConstants#END_DOCUMENT} event. If the current event is {@link
     * XMLStreamConstants#START_ELEMENT}, then the builder will consume events up to the
     * corresponding {@link XMLStreamConstants#END_ELEMENT}. After the object model is completely
     * built, the stream reader will be positioned on the event immediately following this {@link
     * XMLStreamConstants#END_ELEMENT} event. This means that this method can be used in a well
     * defined way to build an object model from a fragment (corresponding to a single element) of
     * the document represented by the stream reader.
     *
     * <p>The builder supports the {@link XMLStreamReader} extension defined by {@link BlobReader}
     * as well as the legacy extension mechanism defined in the documentation of {@link
     * XMLStreamReaderUtils}.
     *
     * <p>The returned builder also performs namespace repairing, i.e. it adds appropriate namespace
     * declarations if undeclared namespaces appear in the StAX stream.
     *
     * @param parser the stream reader to read the XML data from
     * @return the builder
     * @throws OMException if the stream reader is positioned on an event other than {@link
     *     XMLStreamConstants#START_DOCUMENT} or {@link XMLStreamConstants#START_ELEMENT}
     */
     ...
     *
     * <p>See {@link #createStAXOMBuilder(XMLStreamReader)} for more information about the behavior
     * of the returned builder.
     *
     ...
     *
     * @param in the input stream representing the XML document
     * @param encoding the charset encoding of the XML document or <code>null</code> if the parser
     ...
     */
    public static OMXMLParserWrapper createOMBuilder(
            OMFactory omFactory, StAXParserConfiguration configuration, InputStream in) {
     ...
     * stream with the default parser configuration defined by {@link
    ...
    /**
     * Create an object model builder that reads a plain XML document from the provided {@link
     * Source}. When used with a {@link DOMSource} or {@link SAXSource}, entities are expanded, i.e.
     * the method has the same behavior as {@link #createOMBuilder(Node, boolean)} and {@link
     * #createOMBuilder(SAXSource, boolean)} with {@code expandEntityReferences} set to {@code
     * true}.
     *
     ...
     * using a specified object model factory. When used with a {@link DOMSource} or {@link
     * SAXSource}, entities are expanded, i.e. the method has the same behavior as {@link
     * #createOMBuilder(OMFactory, Node, boolean)} and {@link #createOMBuilder(OMFactory, SAXSource,
     * boolean)} with {@code expandEntityReferences} set to {@code true}.
     *
     * @param omFactory the object model factory to use
     * @param source the source of the XML document
     * @return the builder
     ...
     * uses a particular Axiom implementation. The method will select the appropriate {@link
     * SOAPFactory} based on the namespace URI of the SOAP envelope.
     *
     * <p>See {@link #createStAXOMBuilder(XMLStreamReader)} for more information about the behavior
     * of the returned builder.
     *
     * @param metaFactory the meta factory for the Axiom implementation to use
     * @param parser the stream reader to read the XML data from
     * @return the builder
     */
     ...
     * method will select the appropriate {@link SOAPFactory} based on the namespace URI of the SOAP
     * envelope.
     *
     * <p>See {@link #createStAXOMBuilder(XMLStreamReader)} for more information about the behavior
     * of the returned builder.
     ...
     *
     * @param in the input stream containing the SOAP message
     * @param encoding the charset encoding of the SOAP message or <code>null</code> if the parser
     *     should determine the charset encoding
     * @return the builder
     */
     ...
     * of the SOAP envelope. It will configure the underlying parser as specified by {@link
     * StAXParserConfiguration#SOAP}.
     *
     * @param in the character stream containing the SOAP message
     * @return the builder
     */
    ...
    /**
     * Create an object model builder for SOAP that reads a message from the provided character
     * stream using a particular Axiom implementation. The method will select the appropriate {@link
     ...
     * Source}. The method will select the appropriate {@link SOAPFactory} based on the namespace
     * URI of the SOAP envelope.
     *
     ...
     * using a particular Axiom implementation. The method will select the appropriate {@link
     * SOAPFactory} based on the namespace URI of the SOAP envelope.
     *
     * @param metaFactory the meta factory for the Axiom implementation to use
     * @param source the source of the SOAP message
     ...
     * will determine the SOAP version based on the content type information from the {@link
     * MultipartBody} object. It will configure the underlying parser as specified by {@link
     * StAXParserConfiguration#SOAP}.
     *
     * @param message the MIME message
     * @return the builder
    ...
    public static SOAPModelBuilder createSOAPModelBuilder(
        ...
        if (builder.getSOAPMessage().getOMFactory() != soapFactory) {
            throw new SOAPProcessingException(
                    "Invalid SOAP namespace URI. " + "Expected " + soapFactory.getSoapVersionURI(),
