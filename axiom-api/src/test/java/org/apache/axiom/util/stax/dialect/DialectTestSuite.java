...
public class DialectTestSuite {
    ...
    public Stream<DynamicNode> tests() {
        MatrixTestNode root = new FanOutNode<>(
                Multiton.getInstances(StAXImplementation.class),
                (binder, value) -> binder.bind(StAXImplementationAdapter.class)
                        .toInstance(value.getAdapter(StAXImplementationAdapter.class)),
                ...
                new ParentNode(
                        ...
                        new FanOutNode<>(
                                ImmutableList.of(
                                        ...
                                        Pair.of("UnicodeLittle", Set.of("UTF-16", "UTF-16LE")),
                                        ...
                                        Pair.of("UnicodeLittleUnmarked", Set.of("UTF-16LE"))),
                                (binder, value) -> {
                        ...
                        new FanOutNode<>(
                                ImmutableList.of(
                                        ...
                                        Pair.of(XMLStreamConstants.PROCESSING_INSTRUCTION, true),
                                ...
                                LabelBinding.simpleString("event", v -> XMLEventUtils.getEventTypeString(v.getLeft())),
                                new MatrixTest(TestGetLocalNameIllegalStateException.class)),
                        new FanOutNode<>(
                                ImmutableList.of(
                                        Pair.of(XMLStreamConstants.START_ELEMENT, false),
                                        Pair.of(XMLStreamConstants.END_ELEMENT, false),
                                ...
                                LabelBinding.simpleString("event", v -> XMLEventUtils.getEventTypeString(v.getLeft())),
                                new ParentNode(
                                        new MatrixTest(TestGetNameIllegalStateException.class),
                                        new MatrixTest(TestGetNamespaceURIIllegalStateException.class),
                                        new MatrixTest(TestGetPrefixIllegalStateException.class))),
                        ...
                        new FanOutNode<>(
                                ImmutableList.of(
                                        ...
                                        Pair.of(XMLStreamConstants.PROCESSING_INSTRUCTION, false),
        ...
        return root.toDynamicNodes(MatrixTestFilters.builder()
                ...
                .add(TestClose.class, "(&(implementation=stax-1.2.0.jar)(type=InputStream))")
                .build());
    }
}
