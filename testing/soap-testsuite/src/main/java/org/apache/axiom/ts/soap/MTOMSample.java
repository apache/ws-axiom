...
public class MTOMSample extends XOPSample {
    public static final MTOMSample SAMPLE1 = new MTOMSample(
            "sample1.msg",
            "multipart/related; "
    ...
    public static final MTOMSample SAMPLE2 = new MTOMSample(
            "sample2.msg",
     ...
     */
    public static final MTOMSample QUOTED_PRINTABLE = new MTOMSample(
