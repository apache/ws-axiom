...
public abstract class XSLTImplementation extends Multiton {
     ...
     *
     * @return <code>true</code> if the XSLT implementation will invoke the methods on the {@link
     *     LexicalHandler} set on the {@link SAXResult}, <code>false</code> otherwise
     */
