...
public class ConfigurableDataHandlerTest {
    ...
    public void testContentTransferEncoding() {
        ConfigurableDataHandler dh = new ConfigurableDataHandler(new byte[10], "application/octet-stream");
        dh.setTransferEncoding("base64");
        assertThat(ConfigurableDataHandler.CONTENT_TRANSFER_ENCODING_POLICY.getContentTransferEncoding(
                        DataHandlerUtils.toBlob(dh), new ContentType(MediaType.APPLICATION_OCTET_STREAM)))
