 ...
 *
 * <ul>
 *   <li>A MIME multipart message that comprises a root part and a set of attachment parts. Axiom
 *       uses deferred parsing to process the message, i.e. the parts and their content are loaded
 *       on-demand.
 ...
 *
 * <p>Note that this class is intentionally not public. It is for <b>internal use only</b>. However,
 * in a later Axiom version we may want to refactor this API to make it public, in which case {@link
