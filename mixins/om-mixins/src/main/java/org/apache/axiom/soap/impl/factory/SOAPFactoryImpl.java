...
public abstract class SOAPFactoryImpl extends OMFactoryImpl implements SOAPFactory {
    ...
    protected final <T extends AxiomSOAPElement> T createSOAPElement(
            AxiomElementType<T> type, OMElement parent, QName qname) {
        return createSOAPElement(type, parent, qname, null, -1);
    }

    protected final <T extends AxiomSOAPElement> T createSOAPElement(
            AxiomElementType<T> type, OMElement parent, QName qname, Sequence sequence, int pos) {
    ...
    public final SOAPMessage createSOAPMessage() {
        AxiomSOAPMessage message = nodeFactory.createSOAPMessage();
    ...
    public final SOAPHeaderBlock createSOAPHeaderBlock(String localName, OMNamespace ns) {
        return createAxiomElement(getSOAPHelper().getHeaderBlockType(), null, localName, ns);
    }
    ...
    public final SOAPHeaderBlock createSOAPHeaderBlock(OMElement element) {
        return importElement(element, getSOAPHelper().getHeaderBlockType());
    }
    ...
    public final SOAPFault createSOAPFault(SOAPBody parent) {
        SOAPHelper helper = getSOAPHelper();
        return createSOAPElement(helper.getFaultType(), parent, helper.getFaultQName());
    }
    ...
    public final SOAPFaultCode createSOAPFaultCode(SOAPFault parent) {
        SOAPHelper helper = getSOAPHelper();
        return createSOAPElement(helper.getFaultCodeType(), parent, helper.getFaultCodeQName());
    }
    ...
    public final SOAPFaultReason createSOAPFaultReason(SOAPFault parent) {
        SOAPHelper helper = getSOAPHelper();
        return createSOAPElement(helper.getFaultReasonType(), parent, helper.getFaultReasonQName());
    }
    ...
    public final SOAPFaultRole createSOAPFaultRole(SOAPFault parent) {
        SOAPHelper helper = getSOAPHelper();
        return createSOAPElement(helper.getFaultRoleType(), parent, helper.getFaultRoleQName());
    }
    ...
    public final SOAPFaultDetail createSOAPFaultDetail(SOAPFault parent) {
        SOAPHelper helper = getSOAPHelper();
        return createSOAPElement(helper.getFaultDetailType(), parent, helper.getFaultDetailQName());
    }
