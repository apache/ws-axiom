...
public class CommonUtils {
    ...
    /**
     * Writes the om to a log.debug. This method assumes optimized mtom attachments Also calculates
    ...
    /**
     * A "textual part" has one or more of the following criteria 1) a content-type that start with
     * "text" "application/xml" or "application/soap" 2) has a charset parameter on the
     * content-type.
     *
     * <p>Example: An part with a content-type of "image/gif" is a non-textual attachment. An part
     * with a content-type of "application/soap+xml" is an textual attachment
     *
     * @param contentType
